...
ingredients = {
    'meats': ['ribeye', 'mortadella', 'procutto', 'pastrami', 'brisket', 'maple turkey', 'veggie burger'],
    'cheeses': ['burratta', 'munster', 'mimolette', 'pepper jack', 'swiss', 'american'],
    'toppings': ['lettuce', 'tomato', 'red onion', 'pickels','yellow peppers', 'cucumbers', 'sprouts']
}
    ...
    def get(self, request):
        if request.method == 'GET':
            return render(
                ...
                contex = {'ingredients': ingredients.keys()}
            )
