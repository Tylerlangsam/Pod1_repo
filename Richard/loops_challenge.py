...
for i in range(len(days)):
    print(f'your favorite thing to do on {days[i]} is {activities[i]}')
...
for day in days:
    ...
    if temperature < 50:
        ...
        print("it's pretty chilly.  put on a sweater!")
    else:
        print("it's warm, might be sunny. better put on some suncreen.")
...
happy = int(input('How many times would you like to be wished happy birthday? \n'))
for i in range(happy):
    print(f'Happy birthday to you - {i+1} times')
...
outside = int(0)
while outside < 65:
    outside = int(input('What temperature is it outside? \n'))
    print('it is so cold, please wear a sweater.')
print('Springtime is here!  Spring has sprung!')
