...
print('Question 5')
# add_song(my_playlist,{'artist':'Blur','title':'Wonderwall'},{'artist':'Taylor Swift','title':'You Belong to Me'})
add_song(my_playlist,{'artist':'Blur','title':'Wonderwall'})
add_song(my_playlist,{'artist':'Taylor Swift','title':'You Belong to Me'})
display_playlist(my_playlist)
...
print(f'Average number is {numpy.mean (monthly_plays)}')
