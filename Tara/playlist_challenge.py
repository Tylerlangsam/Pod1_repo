...
add_song(my_playlist,{' artist': 'Jill Scott', 'title': 'Love Rain'})
...
print('Question 5')
add_song(my_playlist,{ 'artist': 'Sade', 'title': 'No Ordinary Love'})
add_song(my_playlist,{' artist': 'Ella Fitzgerald', 'titile': 'My Funny Valentine'})
...
avg_mnth_plys = np.mean(monthly_plays)
print(avg_mnth_plys)
