...
num_whishes = int(input('How many times would you like to be wished happy birthday?'))
for _ in range(num_whishes):
...
outside = int()
while outside < 65:
    outside = int(input('What is the temperature today?'))
    print('Make sure to grab a sweater.')
print('The flowers are blooming, spring has sprung!')
