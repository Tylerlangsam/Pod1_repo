...
print(type(validate_user_imput()))
...
user_number = validate_user_imput()
...
def print_tenth_item(top_ten):
    try:
        print(f'The tenth item in the list{top_ten[9]}')
    except ValueError:
        print(f'There are not ten items in this list.')
