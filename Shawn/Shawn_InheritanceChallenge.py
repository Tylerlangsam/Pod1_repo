...
class BusStation(Station):
    ...
    def show_info(self):
        if open == True:
            print(f"Bus station {self.station_name}, located at {self.location}. on routes{self.routes} is open")
        
        else:
            print(f'Bus station is closed')

Station_Y = BusStation('Magic City','241 Forsyth St', ['Miami', 'Augusta', 'SW Atlanta']) 

Station_Y.show_info()

Station_Y.close_station()
