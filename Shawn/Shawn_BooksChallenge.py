...
# print('\nPart 2\n')
my_library.add('Just Mercy', 'Byan Stevenson')
my_library.add('The New Jim Crow', 'Michelle Alexander')
my_library.add('The Truths We Hold', 'Camila Harris')
my_library.add(' Grandmother\'s Hands ', 'Resmaa Menakem')
...
nyt_bestsellers.add('It Ends With Us', 'Colleen Hooveer')
