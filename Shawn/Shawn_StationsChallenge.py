...
class SubwayStation(Station):
    ...
    def show_info(self):
        print(f'The {self.station_name} station is located at {self.location}. Lines are (self.lines)')
...
# lines: ['1', '2', '3', 'L']
# '''
StationX = SubwayStation('14th street', '14th street and 7th avenue', ['1', '2', '3', 'L'])
...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open:
            print(f'The {self.station_name} located at {self.location} stopping at {self.routes} is open')
        
        else:
            print(f'The {self.station_name} located at {self.location} stopping at {self.routes} is closed.')
