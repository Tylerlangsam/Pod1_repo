...
favorite_things = []
for day in days:
    things_to_do = input(f'What is your favorite thing to do on {day}? ')
    favorite_things.append(things_to_do)
...
favorite_things= []
for d in days:
    today_favorite = input(f"what is your favorite thing to do today? ")
...
for index in range(7):
    print(f'On {days[index]}, your favorite activity is to {favorite_things[index]}.')
...
Num_of_birthday_wishes = int(input(f"How many times would you like to be wished happy birthday?"))



print(Num_of_birthday_wishes)
