...
import numpy as np
from Shawn_PlaylistFunctionsChallenge import *
...
# 'artist' (string)
# 'title' (string)
add_song(my_playlist, {'artist': 'Badda TD', 'title': 'Gang'})
...
add_song(my_playlist, {'artist': 'Badda TD', 'title': 'Feel Like A Boss'})
add_song(my_playlist, {'artist': 'Badda TD', 'title': 'Glitch'})
display_playlist(my_playlist)
...
num_songs = get_playlist_length(my_playlist)
print(num_songs)
...
avg_month_plays= np.mean(monthly_plays)
print(avg_month_plays)
