...
add_song(my_playlist, {'artist': "Elton John", 'title': 'Yellow Brick Road'})
...
print('Question 5')
add_song(my_playlist, {'artist': "Green Day", 'title': 'Dookie'})
add_song(my_playlist, {'artist': "REM", 'title': 'Losing My Religion'})
display_playlist(my_playlist)
...
print("mean of monthly_plays : ", np.mean(monthly_plays))
