...
class BusStation(Station):
    ...
    def show_info(self):
        if self.open == True:
            ...
            self.hours = "closed"
        print(f"Bus station name is {self.station_name}. Routes are {self.routes}, and is currently {self.hours}")               

station2 = BusStation("Union Station", "1st Street NE and Massachuests Ave", "NYC, Philadelphia, Richmond")
station2.show_info()
