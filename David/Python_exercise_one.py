...
meal = "Sandwich"
print("Tonight I want", meal, "for dinner.")
...
#added underscore to variable name. Added end parense to close string. Removed hashtag so code would not be commented out.
