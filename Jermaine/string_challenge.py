...
ingredients = f'These are the ingredients, {ingredient_1}, {ingredient_2}, {ingredient_3}, {ingredient_4}'
print(ingredients)
...
print(f'Roughly how many times a week do you make time to {activity}, {frequency}.')
