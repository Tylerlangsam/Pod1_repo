...
from Jermaine.book_class import Book
...
for i in range(len(my_library.books)):
    print (my_library.books[i])

for book in my_library.books:
    print(book.title)

for i in range(len(my_library.books)):
    print (my_library.books[i].title)
...
nyt_bestsellers.add("Invisible Child ","Andrea Elliott")
nyt_bestsellers.add("Malcolm X: A live Reinvention","Manning Marable")
...
titles = [book.title for book in my_library.books]
titles.sort()
print(titles)

nyt_bestsellers.display_titles()
titles_nyt = [book.title for book in nyt_bestsellers.books]
titles_nyt.sort()
print(titles_nyt) 