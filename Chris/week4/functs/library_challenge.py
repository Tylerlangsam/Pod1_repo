...
# books_with_details is a list of dicts of which are comprised of 3 key value pairs: title, author, description
print(type(books_with_details))      # -> list
print(type(books_with_details[0]))   # -> dict
...
def search_by_author(authr):
    titles = []
    for book in books_with_details:
        if book['author'] == authr:
...
test = search_by_author('Timothy Snyder')
print(test)
