...
# 'artist' (string)
# 'title' (string)
pf.add_song(my_playlist, {'artist': 'Morgan Wallen', 'title': 'The Way I Talk'})
...
print('Question 5')
pf.add_song(my_playlist, {'artist': 'Shinedown', 'title': 'Monster'})
pf.add_song(my_playlist, {'artist': 'HellYeah', 'title': 'Moth'})
pf.display_playlist(my_playlist)
...
print('Question 6')
playlist_len = pf.get_playlist_length(my_playlist)
print(playlist_len)
