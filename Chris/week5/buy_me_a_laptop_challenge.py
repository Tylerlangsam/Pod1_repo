...
mac_pro_prices = laptops[0]['types'][1]['price']
for price in mac_pro_prices:
    print(price)
...
colors = laptops[1]['types'][0]['colors']
for color in colors:
    print(color)
...
print('#############################')
print()
print('Printing the description of Dell XPS laptop.')
print()
...
print('#############################')
print()
print('Updating the laptops dictionary')
laptops[0]['types'][0]['colors'].remove('space gray')
laptops[0]['types'][0]['storage'].remove('1 TB SSD')

# Unit testing
# print(laptops[0]['types'][0]['colors'])
# print(laptops[0]['types'][0]['storage'])
print()
